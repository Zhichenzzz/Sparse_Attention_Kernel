...
@pytest.mark.parametrize("Z, H, N_CTX, HEAD_DIM", [(2, 2, 1113, 64)])
    ...
    for causal in [True, False]:
        ...
        configs.append(
            triton.testing.Benchmark(
                ...
                ylabel="ms",
                plot_name=f"flash-attention-batch{BATCH}-head{N_HEADS}-d{HEAD_DIM}-{mode}-causal={causal}",
                args={
                    "H": N_HEADS,
                    "BATCH": BATCH,
                    "HEAD_DIM": HEAD_DIM,
...
if __name__ == "__main__":
    ...
    # bench_flash_attention.run(save_path="./flash_attn_2/", print_data=True)
